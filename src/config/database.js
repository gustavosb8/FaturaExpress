...
const bd = new sqlite3.Database('faturaexpress.db');
...
INSERT INTO usuarios (
    ...
    email,
    senha
) SELECT 'Gustavo Bastos', 'gustavo_s.bastos@hotmail.com', '123' WHERE NOT EXISTS (SELECT * FROM usuarios WHERE email = 'gustavo_s.bastos@hotmail.com')
`;
